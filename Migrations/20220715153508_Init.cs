    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_interviewerAttributes", x => x.InterviewerId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    JobSeekerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AblityKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AblityContent = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ablities", x => x.JobSeekerId);
                    table.ForeignKey(
